...
def main() -> int:
    ...
    if "--selfcheck" in sys.argv:
        from lib import (devices, es_collections, es_systems, localpolicy,  # noqa: F401
                         ...
                         standalone_preview)
        from lib.madsrv import (backends_cmds, capture_cmds, device_cmds,  # noqa: F401
                                policy_cmds, preview_cmds, rpc, systems_cmds)
    ...
    from lib.madsrv import (backends_cmds, capture_cmds, device_cmds,  # noqa: F401
                            policy_cmds, preview_cmds, systems_cmds)  # (register methods)
    assert "tkinter" not in sys.modules, "tkinter leaked into the backend!"
