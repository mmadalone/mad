    ...
    def setUp(self):
        ...
        self._p = [
            mock.patch.object(game_files, "resolve_game_assets",
                              lambda s, st, systems=None, emucfg=True: self.canned),
...
class GameAssetsRPC(unittest.TestCase):
    def test_live_returns_tickable_groups(self):
        canned = [{"key": "rom", "label": "ROM", "category": "roms", "present": True,
                  ...
                  {"key": "saves", "label": "Save", "category": "saves", "present": False,
                   "size": 0, "files": []}]
        with mock.patch.object(game_files, "resolve_game_assets", lambda s, st, systems=None, emucfg=True: canned):
    ...
    def test_game_id_form_accepted(self):
        with mock.patch.object(game_files, "resolve_game_assets", lambda s, st, systems=None, emucfg=True: []):
